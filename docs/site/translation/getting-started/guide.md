...
4. It is important to vote to confirm the best item, even if it already appears in the Winning column.
...
6. Once you are done with all the sections, go to [Dashboard](#dashboard) (below).
7. Under the English column, look for "**i**" for additional information and "**e**" for an example.
