...
public class TestAliases extends TestFmwk {
     ...
     * then replacing it by inheritance marker should have no effect on the resolved value in a child locale.
    ...
    public void TestInheritanceReplacement() {
        ...
        System.out.println("TestInheritanceReplacement calling first checkValues");
        ...
        System.out.println("TestInheritanceReplacement calling second checkValues");
        checkValues(onepath, otherpath, enResolved, en001Resolved);
    }
