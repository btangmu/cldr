...
public class SurveyAjax extends HttpServlet {
    ...
    public static void includeJavaScript(HttpServletRequest request, Writer out) throws IOException {
        ...
        String rev = "?v=" + CLDRConfig.getInstance().getProperty("CLDR_DIR_HASH");
        String tail = "'></script>\n";

        out.write(prefix + "jquery.autosize.min.js" + tail);

        out.write(prefix + "survey.js" + rev + tail);
        out.write(prefix + "CldrStAjax.js" + rev + tail);
        out.write(prefix + "CldrSurveyVettingLoader.js" + rev + tail);
        out.write(prefix + "CldrSurveyVettingTable.js" + rev + tail);

        out.write(prefix + "bootstrap.min.js" + tail);

        out.write(prefix + "redesign.js" + rev + tail);
        out.write(prefix + "review.js" + rev + tail);
    }
}
