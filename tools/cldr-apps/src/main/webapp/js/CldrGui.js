	...
	const vhtml1 =
     ...
     const vhtml2 =
      ...
      const vhtml3 =
            ...
            + "     \n"
            + "             \n"
            + "      <div id='betadiv' class='beta'  style='display: none'>\n"
            + "            \n"
            + "      </div>\n"
            + "</div>\n"
		...
		const hiddenHtml = "<div style='display: none' id='hidden-stuff'>\n"
            ...
            + "    <th class='partsection' colspan='7'>\n"
            + "        <a>Partition</a>\n"
            + "    </th>\n"
            + "</tr>\n"
            + "</tbody>\n"
            ...
            + "</span>\n"
            + "\n"
            + "<div id='proto-sortmode' class='d-sortmode'>\n"
            + "</div>\n"
