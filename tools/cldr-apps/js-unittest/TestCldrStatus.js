...

{
    ...
    describe('vhtml', function() {
		const htmlStr = cldrTest.parseAsMimeType(vhtml, 'text/html');
		it('should return good html', function() {
			assert(htmlStr || false, 'parses OK as html');
		});
	});
    describe('hiddenHtml', function() {
		const htmlStr = cldrTest.parseAsMimeType(hiddenHtml, 'text/html');
		it('should return good html', function() {
			assert(htmlStr || false, 'parses OK as html');
		});
	});
