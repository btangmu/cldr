...

{
  ...
  describe("cldrListUsers.getTable", function () {
    const html = cldrListUsers.getTable(json, cldrListUsers);
  ...
  describe("cldrListUsers.test.getHtml", function () {
    const html = cldrListUsers.test.getHtml(json);
