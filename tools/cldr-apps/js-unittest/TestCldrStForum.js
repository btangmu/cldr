...

{
	...
	describe('cldrStForum.parseContent', function() {
		...
		it('should return correct result for this json', function() {
			...
			const s1 = "Closedn (Gaeilge) userlevel_tc[v38] 2020-02-06 12:26Closetest"
			...
			const s2 = "Closedn (Gaeilge) userlevel_tc[v38] 2020-02-06 12:20CloseFUrthermore";
			...
			const s3 = "Closedn (Gaeilge) userlevel_tc[v38] 2020-02-06 12:17Closetest"
			...
			const s4 = "Closedn (Gaeilge) userlevel_tc[v38] 2020-02-06 12:12CloseAnd another post from Dashboard."
			...
			const sLast = "Closedn (Microsoft) userlevel_vetter[v28] 2015-05-19 11:58Close...";
