 ...
 *
 * @param {Array} threadPosts the array of posts in the thread
 * @returns {Boolean} true if it has this user's response, else false
 */
...
/**
 * Is the thread with the given array of posts and open request started by the current user?
 *
 * @param {Array} threadPosts the array of posts in the thread
